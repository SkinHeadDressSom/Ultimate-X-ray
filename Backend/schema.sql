...
-- Insert Sample Data
INSERT INTO Patients (patient_id, first_name, last_name, date_of_birth, sex, height_cm, weight_kg, phone, address) VALUES
...
INSERT INTO MedicalRecords (record_id, patient_id, clinical_history, examination_details, findings, impression, recommendations, action_comments, attached_images, status) VALUES
(134985, 93800043, 'Hypertension', 'Routine check-up', 'Lung Fields No evidence of pneumothorax', 'Healthy', 'Maintain diet', 'No issues', 1, 'Examined'),
(211328, 45637289, 'Asthma', 'Follow-up', 'Pleura : Mild pleural thickening on the right side; no pleural effusin noted.', 'Requires monitoring', 'Continue medication', 'Scheduled next visit', 2, 'Pending');
